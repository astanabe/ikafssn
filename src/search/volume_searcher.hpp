...
struct SearchConfig {
    ...
    uint8_t  mode = 2;          // 1 = stage1 only, 2 = stage1+stage2, 3 = stage1+stage2+stage3
                                // (the CLI defaults of ikafssnsearch / ikafssnindex
                                // override this to 1; library callers and tests still
                                // see the legacy stage1+2 default unless they opt out).
    ...
    // v10 (Phase 1): minimum query length.  Queries shorter than this are
