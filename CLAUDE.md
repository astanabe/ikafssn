...
- **posting list header** — the fixed-size metadata at the front of a posting list (e.g. v8 `.kix`: `[u32 distinct_count][u32 body_words]` = 8 B; v8 `.kpx`: 5 × u32 = 20 B).
